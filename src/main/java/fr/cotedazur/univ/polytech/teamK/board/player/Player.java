...
public class Player {
    ...
    private String name ;
    private int score;
    private ArrayList<CarteWagon> cartesWagon;
    ...
    public Player(int id, String name, ArrayList<CarteWagon> cartesWagon, ArrayList<CarteDestination> cartesDestination) {
        this(name);
    ...
    public ArrayList<CarteWagon> getCartesWagon() {return cartesWagon;}
     ...
     */
    public boolean addCardWagon(CarteWagon carte) {
    ...
    public boolean removeCardWagon(Colors color, int number) {
        ...
        for (CarteWagon carte : this.cartesWagon) {
